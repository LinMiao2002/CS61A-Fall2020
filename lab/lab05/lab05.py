...
def add_trees(t1, t2):
    ...
    t_branch = [add_trees(b1,b2) for b1,b2 in zip(branches(t1),branches(t2))]
    l = len(t_branch)
    t_branch += branches(t1)[l:] + branches(t2)[l:]
    return tree(t_label, t_branch)
